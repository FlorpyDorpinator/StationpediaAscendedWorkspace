...
namespace StationpediaAscended.Data
{
    ...
    public class GuideDescription
    {
        ...
        /// <summary>If true, this is a section header (not a clickable guide button)</summary>
        public bool isHeader { get; set; } = false;
        
        /// <summary>Header key for identifying headers</summary>
        public string headerKey { get; set; }
        
        /// <summary>Title text to display for section headers</summary>
